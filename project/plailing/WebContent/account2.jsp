...
<body>
	...
	<div class="subbox">
		...
		<div class="right840">
			<div class="title6">
				<h1>
					<a href="${ctx }/user/finance" class="" id="showBalance">交易记录</a>
				</h1>
				<h1>
					<a href="${ctx }/user/money" class="on" id="showMoney">我的收益</a>
				</h1>
			</div>

			<div class="display" id="moneyDiv" >
				<div class="dqjf">
					当前总收益：<font class="f_orange">${userNowTotleEarning }</font> 元
				</div>
				<div class="jflist">
					<div class="titlei">
						<div class="jfjl">
					...
					<ul class="jfinfo">
						<c:forEach items="${moneyListPage.getList()}" var="mny">
						<li>
							<span class="jfdate" style="width:200px">截止目前</span> 
							<span class="jfyt" style="width:130px">开课收益</span>
							<span class="jfnum" style="width:130px"><font class="f_green">${mny[1] }</font></span> 
							<span class="jfjg" style="width:130px"><a href="#" title="E享课堂开课收益细则">查看收益规则</a></span> 
							<span class="jfxx" style="width:130px"><a href="#" title="交易对应课程">${mny[0] }</a></span>
						</li>
						</c:forEach>
					</ul>
					...
					<div class="pagination-container pagemiddle">
						<span>
							共${moneyListPage.totalPageNum}页
						</span>
						<a class="wordstyle" href="${ctx }/user/money?moneyPageNum=1"><font size="2px"> 首页 </font></a>&nbsp;&nbsp;&nbsp; 
						<a class="wordstyle" href="${ctx }/user/money?moneyPageNum=${moneyListPage.prePageNum }"><font size="2px"> 上一页 </font></a>&nbsp;&nbsp;&nbsp; 
						<a class="wordstyle" href="${ctx }/user/money?moneyPageNum=${moneyListPage.nextPageNum }"><font size="2px"> 下一页 </font></a>&nbsp;&nbsp;&nbsp; 
						<a class="wordstyle" href="${ctx }/user/money?moneyPageNum=${moneyListPage.totalPageNum }"><font size="2px"> 末页 </font></a>&nbsp;&nbsp;&nbsp;
					</div>
					
					<a href="${ctx }/upload" title="现在开课"><input type="submit" value="我要开讲" class="input8"/></a>
					<a href="#" onClick=""  title="将收益转到您的账户"><input type="submit" value="我要提现" class="input8"/></a>
