...
<body style="background:url(${ctx}/img/404.png);background-position:center;background-repeat:no-repeat;">
	...
	<script src="${ctx}/js/collision.min.js" type="text/javascript"
		charset="utf-8"></script>
	<script type="text/javascript">
		function rand(m,n){return m+parseInt((n-m)*Math.random());}
		var says=['怎么回事？','谁撞我','网页找不到！','哎呀！哎呀！','点击返回首页','快找找按钮','点一下试试','试试就试试','OH,NO','404页面','休息一下吧'];
		...
		for(var i=0;i<15;i++){
			...
			var ball=new Ball({
				...
				'sx':rand(1,4),
				'sy':rand(1,4),
				'c':'url(${ctx}/img/paopao'+rand(1,6)+'.png)',
				'opa':rand(60,100)/100,
				'callBack':function(n){
					//this.setB(rand(30,50));
					//this.setM();
					this.setOpa(rand(60,100)/100);
					if(n%3==0){this.setC('url(${ctx}/img/paopao'+rand(1,6)+'.png)')};//撞三次改变下图片
					if(n%50==0){
