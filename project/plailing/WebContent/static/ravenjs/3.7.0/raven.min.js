	...
	return function a(b, c, d) {
		...
		1 : [function(a, b, c) {
			...
			function e(a, b) {
				...
				function(e, f) {
					if (c.length > 0) {
						var g = c.indexOf(this);~g ? c.splice(g + 1) : c.push(this),
		...
		4 : [function(a, b, c) {
			...
			e.prototype = {
				...
				config: function(a, b) {
					var c = this;
					if (this.e) return this.v("error", "Error: Raven has already been configured"),
					this;
					if (!a) return this;
					b && p(b,
					function(a, b) {
					...
					this.i.ignoreErrors = o(this.i.ignoreErrors),
					this.i.ignoreUrls = this.i.ignoreUrls.length ? o(this.i.ignoreUrls) : !1,
					this.i.whitelistUrls = this.i.whitelistUrls.length ? o(this.i.whitelistUrls) : !1,
					this.i.includePaths = o(this.i.includePaths),
					this.i.maxBreadcrumbs = Math.max(0, Math.min(this.i.maxBreadcrumbs || 100, 100));
					var d = {
						xhr: !0,
						console: !0,
						dom: !0,
					...
					return "[object Object]" === {}.toString.call(e) ? e = q(d, e) : e !== !1 && (e = d),
					this.i.autoBreadcrumbs = e,
				...
				install: function() {
					...
					}), this.x(), a.i.autoBreadcrumbs && this.y(), this.z(), this.k = !0),
					Error.stackTraceLimit = this.i.stackTraceLimit,
					this
				},
				setDSN: function(a) {
					var b = this.A(a),
					c = b.path.lastIndexOf("/"),
					d = b.path.substr(1, c);
					this.B = a,
					this.f = b.user,
					this.C = b.pass && b.pass.substr(1),
					this.g = b.path.substr(c + 1),
					this.e = this.D(b),
					this.E = this.e + "/" + d + "api/" + this.g + "/store/"
				},
				context: function(a, b, c) {
					return j(a) && (c = b || [], b = a, a = void 0),
				...
				wrap: function(a, b, c) {
					function d() {
						...
						f = arguments.length,
						g = !a || a && a.deep !== !1;
						for (c && j(c) && c.apply(this, arguments); f--;) d[f] = g ? e.wrap(a, arguments[f]) : arguments[f];
						try {
					...
					var e = this;
					if (k(b) && !j(a)) return a;
					if (j(a) && (b = a, a = void 0), !j(b)) return b;
					try {
						if (b.G) return b;
						if (b.H) return b.H
					} catch(f) {
				...
				captureException: function(a, b) {
					if (!l(a)) return this.captureMessage(a, q({
						trimHeadFrames: 1,
						stacktrace: !0
					},
					b));
				...
				setExtraContext: function(a) {
					return this.N("extra", a),
					this
				},
				setTagsContext: function(a) {
					return this.N("tags", a),
					this
				},
				...
				setDataCallback: function(a) {
					...
					return this.i.dataCallback = j(a) ?
					function(c) {
						return a(c, b)
					}: a,
					this
				...
				setShouldSendCallback: function(a) {
					...
					return this.i.shouldSendCallback = j(a) ?
					function(c) {
						return a(c, b)
					}: a,
					this
				...
				isSetup: function() {
					return this.a ? this.e ? !0 : (this.ravenNotConfiguredError || (this.ravenNotConfiguredError = !0, this.v("error", "Error: Raven has not been configured.")), !1) : !1
				},
				afterLoad: function() {
				...
				x: function() {
					function a(a) {
						return function(b, d) {
							for (var e = new Array(arguments.length), f = 0; e.length > f; ++f) e[f] = arguments[f];
							var g = e[0];
							return j(g) && (e[0] = c.wrap(g)),
							a.apply ? a.apply(this, e) : a(e[0], e[1])
						}
					}
					function b(a) {
						var b = window[a] && window[a].prototype;
						b && b.hasOwnProperty && b.hasOwnProperty("addEventListener") && (x(b, "addEventListener",
						function(b) {
							return function(d, f, g, h) {
								...
								var j;
								return e && e.dom && ("EventTarget" === a || "Node" === a) && ("click" === d ? j = c.P(d) : "keypress" === d && (j = c.R())),
								b.call(this, d, c.wrap(f, void 0, j), g, h)
							}
						},
						d), x(b, "removeEventListener",
						function(a) {
					...
					d = c.q,
					e = this.i.autoBreadcrumbs;
					x(window, "setTimeout", a, d),
					x(window, "setInterval", a, d),
					window.requestAnimationFrame && x(window, "requestAnimationFrame",
					function(a) {
						return function(b) {
							return a(c.wrap(b))
						}
					...
					d);
					for (var f = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"], g = 0; f.length > g; g++) b(f[g]);
					var h = window.jQuery || window.$;
					h && h.fn && h.fn.ready && x(h.fn, "ready",
					function(a) {
						return function(b) {
				...
				y: function() {
					...
					d = b.q;
					if (c.xhr && "XMLHttpRequest" in window) {
						var e = XMLHttpRequest.prototype;
						x(e, "open",
						function(a) {
							return function(c, d) {
								return w(d) && -1 === d.indexOf(b.f) && (this.T = {
									method: c,
									url: d,
									status_code: null
								}),
						...
						function(c) {
							return function(d) {
								...
								for (var f = this,
								g = ["onload", "onerror", "onprogress"], h = 0; g.length > h; h++) a(g[h], f);
								return "onreadystatechange" in f && j(f.onreadystatechange) ? x(f, "onreadystatechange",
								function(a) {
					...
					c.dom && this.b && (document.addEventListener ? (document.addEventListener("click", b.P("click"), !1), document.addEventListener("keypress", b.R(), !1)) : (document.attachEvent("onclick", b.P("click")), document.attachEvent("onkeypress", b.R())));
					var f = window.chrome,
					g = f && f.app && f.app.runtime,
					h = !g && window.history && history.pushState;
					if (c.location && h) {
						var i = window.onpopstate;
						window.onpopstate = function() {
							var a = b.t.href;
							return b.S(b.u, a),
							i ? i.apply(this, arguments) : void 0
						},
						x(history, "pushState",
						function(a) {
							return function() {
					...
					if (c.console && "console" in window && console.log) {
						var k = function(a, c) {
							b.captureBreadcrumb({
								message: a,
								level: c.level,
				...
				L: function(a, b) {
					var c = this,
					d = [];
					if (a.stack && a.stack.length && (p(a.stack,
					function(a, b) {
						var e = c.V(b);
						e && d.push(e)
					}), b && b.trimHeadFrames)) for (var e = 0; b.trimHeadFrames > e && d.length > e; e++) d[e].in_app = !1;
				...
				V: function(a) {
					if (a.url) {
						...
						return b.in_app = !(this.i.includePaths.test && !this.i.includePaths.test(b.filename) || /(Raven|TraceKit)\./.test(b["function"]) || /raven\.(min\.)?js$/.test(b.filename)),
						b
					}
				},
				...
				M: function(a) {
					...
					this.h.tags), a.tags),
					a.extra = q(q({},
					this.h.extra), a.extra),
					a.extra["session:duration"] = d() - this.p,
					this.r && this.r.length > 0 && (a.breadcrumbs = {
						values: [].slice.call(this.r, 0)
					}),
					m(a.tags) && delete a.tags,
					...
					j(b.dataCallback) && (a = b.dataCallback(a) || a),
					a && !m(a) && (!j(b.shouldSendCallback) || b.shouldSendCallback(a)) && this.Y(a)
				},
				Y: function(a, b) {
					var c = this,
					d = this.i;
					if (this.d = a.event_id || (a.event_id = t()), a = this.W(a), this.v("debug", "Raven about to send:", a), this.isSetup()) {
						var e = {
							sentry_version: "7",
						...
						var g = this.E; (d.transport || this.Z).call(this, {
							url: g,
							auth: e,
							data: a,
							options: d,
				...
				N: function(a, b) {
					k(b) ? delete this.h[a] : this.h[a] = q(this.h[a] || {},
					b)
				}
			},
		...
		6 : [function(a, b, c) {
			...
			function f(a) {
				return "[object String]" === u.toString.call(a)
			}
			function g(a) {
			...
			function m(a, b) {
				return u.hasOwnProperty.call(a, b)
			}
			function n(a) {
			...
			function r(a) {
				for (var b, c = 5,
				d = 80,
				e = [], f = 0, g = 0, h = " > ", i = h.length; a && f++<c && (b = s(a), !("html" === b || f > 1 && g + e.length * i + b.length >= d));) e.push(b),
				g += b.length,
				a = a.parentNode;
			...
			function s(a) {
				...
				if (h.push(a.tagName.toLowerCase()), a.id && h.push("#" + a.id), b = a.className, b && f(b)) for (c = b.split(" "), g = 0; c.length > g; g++) h.push("." + c[g]);
				var i = ["type", "name", "title", "alt"];
				for (g = 0; i.length > g; g++) d = i[g],
				e = a.getAttribute(d),
				e && h.push("[" + d + '="' + e + '"]');
				return h.join("")
			}
		...
		7 : [function(a, b, c) {
			...
			i.report = function() {
				...
				function h(a, b, c, f, h) {
					var j = null;
					if (v) i.computeStackTrace.augmentStackTraceWithInitialElement(v, b, c, a),
					o();
			...
			i.computeStackTrace = function() {
				function a(a) {
					if (!h(a.stack) && a.stack) {
						for (var b, c, e = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|<anonymous>).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
						f = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|\[native).*?)(?::(\d+))?(?::(\d+))?\s*$/i,
						g = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i,
				...
				function c(a, f) {
					for (var g, h, j = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i,
					l = [], m = {},
					n = !1, o = c.caller; o && !n; o = o.caller) if (o !== e && o !== i.report) {
						if (h = {
							url: null,
							func: k,
							line: null,
						...
						o.name ? h.func = o.name: (g = j.exec(o.toString())) && (h.func = g[1]), "undefined" == typeof h.func) try {
							h.func = g.input.substring(0, g.input.indexOf("{"))
						} catch(p) {}
						m["" + o] ? n = !0 : m["" + o] = !0,
						l.push(h)
					}
